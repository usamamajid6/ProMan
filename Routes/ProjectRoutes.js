    ...
    try {
        ...
        if (result) {
            ...
            if (!(req.body.team_id === "no-team")) {
                try {
                    const secondResult = await Team.addProject(req.body.team_id, result._id);
                    if (secondResult) {
...
app.put('/updateProjectLeader', async (req, res) => {
    try {
        ...
        if (result) {
            ...
            try {
                const secondResult = await Project.addMember(req.body._id, req.body.leader_id)
                if (secondResult) {
        ...
        if (result) {
            ...
            try {
                ...
                if (secondResult) {
                    ...
                    res.json({
                        status: "Success",
                        message: "Updation of Total Tasks and Efficiency Score Successfully",
                        messageExplain: "Updation of Total Tasks and Efficiency Score in User AND Project Database Succesfully!",
